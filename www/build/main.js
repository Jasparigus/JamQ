...
var NowplayingPage = /** @class */ (function () {
    ...
    NowplayingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPage */])(),
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-nowplaying',template:/*ion-inline-start:"/home/ubuntu/workspace/src/pages/nowplaying/nowplaying.html"*/'<!--\n  Generated template for the NowplayingPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>{{host}}\'s Party\n      <i>#{{ partyKey }}</i>\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  <ion-list>\n    <ion-item clear ion-item *ngFor="let song of songs | async">\n      <ion-thumbnail item-start>\n        <img src="{{song.img}}">\n      </ion-thumbnail>\n      <h2> {{ song.title }} </h2>\n      <p> {{ song.artist }}</p>\n      <button ion-button clear item-end (click)=remove(song.songid)>\n        <ion-icon name="close"></ion-icon>\n      </button>\n    </ion-item>\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"/home/ubuntu/workspace/src/pages/nowplaying/nowplaying.html"*/,
        }),
